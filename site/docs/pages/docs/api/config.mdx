  ...
  head: (
    <>
      ...
      <meta
        ...
        content="Build reliable Ethereum apps & libraries with lightweight, composable, & type-safe modules from viem."
      />{' '}
      // [!code focus]
    </>
  ), // [!code focus]
      ...
      items: [
        ...
        [
          // [!code focus]
          {
            ...
            // [!code focus]
            image: 'https://raw.githubusercontent.com/wevm/.github/main/content/sponsors/paradigm-light.svg' // [!code focus]
          } // [!code focus]
        ] // [!code focus]
      ] // [!code focus]
    }, // [!code focus]
      ...
      items: [
        ...
        [
          // [!code focus]
          {
            ...
            // [!code focus]
            image: 'https://raw.githubusercontent.com/wevm/.github/main/content/sponsors/walletconnect-light.svg' // [!code focus]
          }, // [!code focus]
          {
            // [!code focus]
            ...
            // [!code focus]
            image: 'https://raw.githubusercontent.com/wevm/.github/main/content/sponsors/stripe-light.svg' // [!code focus]
          } // [!code focus]
        ] // [!code focus]
      ] // [!code focus]
    } // [!code focus]
