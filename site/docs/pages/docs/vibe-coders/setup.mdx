...
async function testSetup() {
  try {
    ...
    console.log('✅ Setup working! CHICKEN supply:', totalSupply)
    ...
    await sdk
      ...
      .buy({
        amount: wei(1, 18),
        slippage: 100,
        onSuccess: () => console.log('✅ Buy successful!'),
      })
  } catch (error) {
...
<!-- index.html -->
<script type="module">
  import * as viem from 'https://cdn.jsdelivr.net/npm/viem@2/+esm'
  import { mintclub, wei } from 'https://cdn.jsdelivr.net/npm/@mint.club/v2-sdk@2/+esm'

  window.viem = viem
  window.MintClubV2SDK = { mintclub, wei }
</script>
```
...
**Choose your environment and follow the corresponding setup pattern!** Each setup is optimized for its specific use case. 🎯
